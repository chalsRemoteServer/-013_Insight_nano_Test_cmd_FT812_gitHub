...
{static int32_t rotate = 0;
    ...
    /* display a picture and rotate it when the button on top is activated */
        ...
        EVE_cmd_number_burst(580, 13, 26, EVE_OPT_CENTERX, display_list_size); /* number of bytes written to the display-list by the command co-pro */
        EVE_cmd_number_burst(704, 15, 26, EVE_OPT_CENTERX, num_profile_a); /* duration in us of TFT_loop() for the touch-event part */
        EVE_cmd_number_burst(554, 10, 26, EVE_OPT_CENTERX, num_profile_b); /* duration in us of TFT_loop() for the display-list part */
